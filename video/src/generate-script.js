...
- imagePrompt: 화면에 함께 보여줄 "자료화면" 사진을 생성하기 위한 프롬프트 (영어 또는 한국어). 절대 실존 인물의 얼굴이나 이 사건의 구체적 현장을 그대로 재현하지 마라 — 대신 이 사건과 막연히 관련된 일반적인 장소·사물·분위기(예: 법원 건물 외관, 증권 시황판, 항구의 컨테이너선, 국회의사당 등)를 사실적인 사진 스타일로 묘사해라.
